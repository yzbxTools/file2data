...
def merge_all(json_files: List[str], output_file: str) -> None:
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Merge images, annotations, and categories from multiple COCO JSON files.")
    ...
    merge_all(args.json_files, args.output_file)